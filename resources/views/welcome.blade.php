        ...
        <div class="flex-center position-ref full-height">
            @if (Route::has('login'))
                <div class="top-right links">
                    ...
                    @else
                        <a href="{{ action('Auth\LoginController@showLoginForm') }}">{{ trans('messages.login') }}</a>
                        <a href="{{ action('Auth\RegisterController@showRegistrationForm') }}">{{ trans('messages.register') }}</a>
                    @endif
                </div>
            @endif
